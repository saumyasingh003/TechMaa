...
export const dummyTestimonial = [
  {
    ...
    rating: 5,
    feedback:
      "Techademy completely changed the way I learn new technologies. The courses are structured perfectly, and the dashboard makes tracking progress effortless. I picked up Node.js here, and it helped me in my Amazon interview!",
  },
  {
    name: "Richard Nelson",
    role: "Full Stack Developer @ Samsung",
    image: assets.profile_img_2,
    rating: 4,
    feedback:
      "As a developer, I love how smooth the platform feels. Uploading my own courses was simple, and the built-in analytics helped me understand how students engage with my lessons. Definitely a great tool for both learners and educators.",
  },
  {
    ...
    rating: 4.5,
    feedback:
      "I’ve tried many platforms, but Techademy stands out for its clean UI and flexibility. I enrolled in the backend development track, and the projects were real-world level — great for building a solid portfolio.",
  },
];
